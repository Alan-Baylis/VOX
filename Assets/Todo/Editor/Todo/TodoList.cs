...
public class TodoList : EditorWindow{
    ...
    private string _listDataDirectory = "/Todo/Resources/Todo/";
	private string _listDataAssetPath = "Assets/Todo/Resources/Todo/TodoList.asset";
    ...
    public static void Init(){
        _window = (TodoList) EditorWindow.GetWindow(typeof(TodoList), false, "Todo List", true);
